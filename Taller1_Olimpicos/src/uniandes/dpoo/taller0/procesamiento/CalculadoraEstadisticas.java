...
public class CalculadoraEstadisticas
{
	...
	/*
	 * Retorna el país de un atleta
	 * @param nombreAtleta El nombre del atleta que se esta buscando
	 * @return El país del atleta con el nombre dado o "no encontrado" si no lo encuentra.
	 */
